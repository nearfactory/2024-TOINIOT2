...
// Constants
#define DIR_TOLERANCE 10  /*角度誤差許容範囲*/
#define P_GAIN_DIR 0.95
#define D_GAIN_DIR 0.7

#define BALL_MIN 100
#define BALL_FAR 2500
#define MPB_GAIN 0.80

#define LINEF_COUNT 3
#define LINEL_COUNT 2
#define LINEB_COUNT 3
#define LINER_COUNT 2

#define FRONTTURN_TOLERANCE 5000
#define FRONTTURN_TIME 50
...
void setup() {
  ...
  Serial.println("calibration dir");
}
...
void loop() {
  ...
  if(lineBlock[4] != 0){
    ...
    case 1101:
      motorP(-100, -100, 100, 100, mpL);
      if(lineF > LINEF_COUNT && lastGoal == 0){
        motorP(0, 0, 0, 0, mpL);
        delay(250);
        motorP(75, 75, -75, -75, mpB*MPB_GAIN);
        delay(150);
        motorP(0, 0, 0, 0, mpL);
        delay(250);
        motorP(-75, -75, 75, 75, mpB*MPB_GAIN);
