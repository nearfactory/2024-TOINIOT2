...
bool connectToServer(BLEAddress address_){
  ...
  remote_characteristic_CIPO = remote_service -> getCharacteristic(CIPO_BLE_UUID);
  ...
  if(remote_characteristic_COPI -> canRead()){
    std::string recieved_str = remote_characteristic_COPI -> readValue();
    Serial.print("The characteristic value was : ");
    Serial.println(recieved_str.c_str());
  }

  if(remote_characteristic_COPI -> canNotify()) return true;
};
