...
void refreshLine(void) {
  ...
  if(line[16] + line[17] + line[18] + line[19] + line[21] == 0){
    lineBlock[4] = 0;
  }
  else{
    lineBlock[4] = 1;
  }
  //                     front              left            back_out           back_in            right 
  lineBlock[5] = lineBlock[0]*10000 + lineBlock[1]*1000 + lineBlock[2]*100 + lineBlock[3]*10 + lineBlock[4];
  return;
}
